...
func (_m *Repository) Update(_a0 resource.Element, _a1 resource.Element) (resource.Element, error) {
	ret := _m.Called(_a0, _a1)

	var r0 resource.Element
	if rf, ok := ret.Get(0).(func(resource.Element, resource.Element) resource.Element); ok {
		r0 = rf(_a0, _a1)
	} else {
		r0 = ret.Get(0).(resource.Element)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(resource.Element, resource.Element) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
