...
<Card className="box-shadow mb-3 pricing-card">
  <Card.Header>
    <h4 className="font-weight-normal">Free + Early Adopters</h4>
  </Card.Header>
  <Card.Body>
    <Card.Title className="pricing-card-title">
      <div className="list-unstyled my-4">
          <div className="mb-3 d-flex">
            ...
            <div className="pt-1 mt-1"><del>100</del> 1000 Resources</div>
          </div>
          <div className="mb-3 d-flex">
            <img alt="icon unavailable" src={permission} className="mr-2 icon" />
            <div className="pt-1 mt-1"><del>100</del> 1000 Permissions</div>
          </div>
          <div className="mb-3 d-flex">
    ...
    <Button className="pricing-btn" variant="primary" size="lg" block>Sign Up and Get Started</Button>
  </Card.Body>
</Card>
</Col>